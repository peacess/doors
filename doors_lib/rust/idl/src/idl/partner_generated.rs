...
/// previous, unchecked, behavior use
/// `root_as_partner_unchecked`.
pub fn root_as_partner_with_opts<'b, 'o>(
...
#[inline]
pub fn finish_size_prefixed_partner_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<Partner<'a>>) {
