...
impl<'a> Regestry<'a> {
  pub const VT_PARTERID: flatbuffers::VOffsetT = 4;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.parterId { builder.add_parterId(x); }
    builder.finish()
  }


  #[inline]
  pub fn parterId(&self) -> Option<&'a super::base::PartnerId> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::base::PartnerId>(Regestry::VT_PARTERID, None)}
  }
}
...
impl flatbuffers::Verifiable for Regestry<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<super::base::PartnerId>("parterId", Self::VT_PARTERID, false)?
     .finish();
    Ok(())
  }
}
pub struct RegestryArgs<'a> {
    pub parterId: Option<&'a super::base::PartnerId>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RegestryBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_parterId(&mut self, parterId: &super::base::PartnerId) {
    self.fbb_.push_slot_always::<&super::base::PartnerId>(Regestry::VT_PARTERID, parterId);
  }
  #[inline]
...
impl core::fmt::Debug for Regestry<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Regestry");
      ds.field("parterId", &self.parterId());
      ds.finish()
  }
}
}  // pub mod net_discovery
