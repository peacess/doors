...
import './base_idl_generated.dart' as idl;
...
class Partner {
  ...
  Ubyte16? get terminalId => Ubyte16.reader.vTableGetNullable(_bc, _bcOffset, 6);
  Ubyte16? get partnerId => Ubyte16.reader.vTableGetNullable(_bc, _bcOffset, 8);
  ...
  Timestamp? get createTs => Timestamp.reader.vTableGetNullable(_bc, _bcOffset, 16);
...
class PartnerObjectBuilder extends fb.ObjectBuilder {
  ...
  final Ubyte16ObjectBuilder? _terminalId;
  final Ubyte16ObjectBuilder? _partnerId;
  final String? _name;
  final String? _ip;
  final int? _port;
  final TimestampObjectBuilder? _createTs;

  PartnerObjectBuilder({
    Ubyte16ObjectBuilder? id,
    Ubyte16ObjectBuilder? terminalId,
    Ubyte16ObjectBuilder? partnerId,
    String? name,
    String? ip,
    int? port,
    TimestampObjectBuilder? createTs,
  })
      : _id = id,
...
class _OnLineReader extends fb.TableReader<OnLine> {
  ...
  @override
  OnLine createObject(fb.BufferContext bc, int offset) => 
    OnLine._(bc, offset);
}
...
class OnLineAck {
  ...
  Timestamp? get ts => Timestamp.reader.vTableGetNullable(_bc, _bcOffset, 10);
...
class _OnLineAckReader extends fb.TableReader<OnLineAck> {
  ...
  @override
  OnLineAck createObject(fb.BufferContext bc, int offset) => 
    OnLineAck._(bc, offset);
}
