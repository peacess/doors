...
func (rcv *TextMessage) Ts(obj *base.Timestamp) *base.Timestamp {
...
func TextMessageAddTs(builder *flatbuffers.Builder, ts flatbuffers.UOffsetT) {
	builder.PrependStructSlot(5, flatbuffers.UOffsetT(ts), 0)
}
