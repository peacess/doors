...
func (rcv *OnLineAck) Header(obj *base.Header) *base.Header {
...
func (rcv *OnLineAck) Id(obj *base.UByte16) *base.UByte16 {
...
func (rcv *OnLineAck) Ts(obj *base.Timestamp) *base.Timestamp {
