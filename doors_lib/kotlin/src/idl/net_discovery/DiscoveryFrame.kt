...
class DiscoveryFrame : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : DiscoveryFrame {
        __init(_i, _bb)
        return this
    }
    ...
    companion object {
        ...
        fun getRootAsDiscoveryFrame(_bb: ByteBuffer): DiscoveryFrame = getRootAsDiscoveryFrame(_bb, DiscoveryFrame())
        fun getRootAsDiscoveryFrame(_bb: ByteBuffer, obj: DiscoveryFrame): DiscoveryFrame {
        ...
        fun endDiscoveryFrame(builder: FlatBufferBuilder) : Int {
