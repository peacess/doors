...
impl<'a> Frame<'a> {
  ...
  pub fn version(&self) -> i16 {
    self._tab.get::<i16>(Frame::VT_VERSION, Some(0)).unwrap()
  }
  #[inline]
...
impl<'a: 'b, 'b> FrameBuilder<'a, 'b> {
  ...
  pub fn add_version(&mut self, version: i16) {
    self.fbb_.push_slot::<i16>(Frame::VT_VERSION, version, 0);
  }
  #[inline]
...
impl<'a> Message<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.to_id { builder.add_to_id(x); }
      builder.finish()
    }

    pub const VT_TO_ID: flatbuffers::VOffsetT = 4;
  ...
  #[inline]
  pub fn to_id(&self) -> Option<&'a Int128_64> {
    self._tab.get::<Int128_64>(Message::VT_TO_ID, None)
  }
  #[inline]
  pub fn from_id(&self) -> Option<&'a Int128_64> {
    self._tab.get::<Int128_64>(Message::VT_FROM_ID, None)
  }
  #[inline]
  pub fn id(&self) -> Option<&'a Int128_64> {
    self._tab.get::<Int128_64>(Message::VT_ID, None)
  }
  #[inline]
  pub fn ts(&self) -> Option<&'a Timestamp> {
    self._tab.get::<Timestamp>(Message::VT_TS, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for Message<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<Int128_64>(&"to_id", Self::VT_TO_ID, false)?
     .visit_field::<Int128_64>(&"from_id", Self::VT_FROM_ID, false)?
     .visit_field::<Int128_64>(&"id", Self::VT_ID, false)?
...
pub struct MessageArgs<'a> {
    pub to_id: Option<&'a Int128_64>,
    pub from_id: Option<&'a Int128_64>,
    pub id: Option<&'a Int128_64>,
...
impl<'a: 'b, 'b> MessageBuilder<'a, 'b> {
  #[inline]
  pub fn add_to_id(&mut self, to_id: &Int128_64) {
    self.fbb_.push_slot_always::<&Int128_64>(Message::VT_TO_ID, to_id);
  }
  #[inline]
  pub fn add_from_id(&mut self, from_id: &Int128_64) {
    self.fbb_.push_slot_always::<&Int128_64>(Message::VT_FROM_ID, from_id);
  }
  #[inline]
  pub fn add_id(&mut self, id: &Int128_64) {
    self.fbb_.push_slot_always::<&Int128_64>(Message::VT_ID, id);
  }
  #[inline]
  pub fn add_ts(&mut self, ts: &Timestamp) {
    self.fbb_.push_slot_always::<&Timestamp>(Message::VT_TS, ts);
  }
  #[inline]
